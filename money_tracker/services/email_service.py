...
class EmailService:
    ...
    def __init__(self):
        """Initialize the email service with settings from config."""
        self.host = settings.EMAIL_HOST
        self.port = settings.EMAIL_PORT
        self.username = settings.EMAIL_USERNAME
        self.password = settings.EMAIL_PASSWORD
        self.use_ssl = settings.EMAIL_USE_SSL
        self.bank_email_addresses = settings.BANK_EMAIL_ADDRESSES
        self.bank_email_subjects = settings.BANK_EMAIL_SUBJECTS
